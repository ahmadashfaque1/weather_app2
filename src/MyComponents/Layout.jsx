        ...
        <div>
            <div className="main-header">WEATHER APP
                <div className="main-header-search-buttons">
                    ...
                    <button onClick={() => handleLinkClick("/")} className={activeLink === '/' || activeLink === '' ? "main-header-search-buttons--active" : "main-header-search-buttons-right"}>Search Weather</button>
